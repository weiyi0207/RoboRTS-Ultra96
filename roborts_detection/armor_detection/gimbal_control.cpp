...
void GimbalContrl::Transform(cv::Point3d &postion, float &pitch, float &yaw) {
  pitch =
      -GetPitch((postion.z + offset_.z) / 1000, -(postion.y + offset_.y) / 1000, 15) + (float)(offset_pitch_ * 3.1415926535 / 180);
