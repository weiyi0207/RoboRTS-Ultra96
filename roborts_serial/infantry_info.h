...
#ifndef ROBORTS_SERIAL_INFANTRY_INFO_H
#define ROBORTS_SERIAL_INFANTRY_INFO_H
...
typedef enum {
  ...
  DETECTION_CTRL_ID = 0x1101,
  DETECTION_RESULT_ID = 0x501,
} CommandID;
...
/**
  * @brief  Enemy Detection Ctrl(0x1101)
  */
typedef struct {
  uint8_t action; /* see msg::EnemyDetectionCtrl */
} __attribute__((packed)) DetectionCtrl;
...
typedef struct {
  ...
  float dist;
  uint8_t valid;
} __attribute__((packed)) DetectionResult;
