...
#ifndef ROBORTS_SERIAL_COM_NODE_H
#define ROBORTS_SERIAL_COM_NODE_H
...
#include "proto/serial_com_config.pb.h"
...
class SerialComNode {
 ...
 private:
   ...
   */
  void GimbalControlCallback(const roborts_msgs::GimbalAngle::ConstPtr &msg);
  ...
  void DetectionCallback(const roborts_msgs::GimbalAngle::ConstPtr &msg);
  
  // void SetChassisStatus(bool relax, float w);

  void RemoteCtrlHandle();
  ...
  ros::Subscriber sub_cmd_vel_, sub_cmd_gim_, sub_cmd_sho_;
  ros::Publisher odom_pub_, gim_pub_, uwb_pose_pub_, tracking_ctrl_pub_, enemy_det_pub_;
  roborts_msgs::GimbalAngle gim_angle_;
